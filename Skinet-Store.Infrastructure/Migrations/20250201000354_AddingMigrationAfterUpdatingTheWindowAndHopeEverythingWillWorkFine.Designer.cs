...
namespace Skinet_Store.Infrastructure.Migrations
{
    ...
    [Migration("20250201000354_AddingMigrationAfterUpdatingTheWindowAndHopeEverythingWillWorkFine")]
    partial class AddingMigrationAfterUpdatingTheWindowAndHopeEverythingWillWorkFine
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Skinet_Store.Core.Entities.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Skinet_Store.Core.Entities.DelieveryMehod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Skinet_Store.Core.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Skinet_Store.Core.Entities.ApplicationUser", b =>
                {
                    b.HasOne("Skinet_Store.Core.Entities.Address", "Address")
                        .WithMany()
